...
public class Home extends JFrame {
    ...
    private Home() {
        ...
        ChangeLogin.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                String Login = JOptionPane.showInputDialog(ChangeLogin, "Votre nouveau login :");
                while (app.IsLoginUsed(Login)) {
    ...
    public void addMessagesend(String tosend, boolean sender) {
        ...
        this.expediteur.add(pmess, "wrap, w 75%");
